{ ... }: {
  flake.modules.homeManager.gaming =
    ...
    {
      # Steam is enabled at system level in this module
      ...
      home.packages = with pkgs; [
        ...
        # jdk21 lives in this module (systemPackages) to avoid HM path collisions with JetBrains JDKs
      ];
    };
  flake.modules.nixos.gaming-system =
    { pkgs, ... }:
